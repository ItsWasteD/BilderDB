...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 30. Mrz 2017 um 16:10
...
--
-- Datenbank: `bilderdb_4h_roth`
--
CREATE DATABASE IF NOT EXISTS `bilderdb_4h_roth` DEFAULT CHARACTER SET utf8 COLLATE utf8_german2_ci;
USE `bilderdb_4h_roth`;
...
CREATE TABLE `galleries` (
  ...
  `preview_id` text COLLATE utf8_german2_ci
...
INSERT INTO `galleries` (`id`, `user_id`, `name`, `preview_id`) VALUES
(2, 1, 'Deviii', NULL),
(3, 1, 'Yanis', NULL),
(4, 2, 'Lehrperson', NULL);
...
CREATE TABLE `pictures` (
  ...
  `path` text COLLATE utf8_german2_ci NOT NULL,
  `name` text COLLATE utf8_german2_ci NOT NULL,
  `tags` text COLLATE utf8_german2_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_german2_ci;
...
(1, 'roth.david00@gmail.com', '$2y$10$xOHXF4UaJsYnmQc0Zt4hOeiV3Cpq31YcHK6lcEVHUmdwV9hW2.Lbu'),
(2, 'test@gibb.ch', '$2y$10$tqeFH57wTGi29jc0pHmydebXjXW/1jgoOdkUhjHBCwbpiIBv.moUu'),
(3, 'tim.leibacher@gibb.ch', '$2y$10$HRNJ.f7RTlpiwLvAnnmDxukw0GU30je4Wdaye1rpY4Fu29qZ4TdmC');
...
--
ALTER TABLE `pictures`
  ADD CONSTRAINT `pictures_ibfk_1` FOREIGN KEY (`gallery_id`) REFERENCES `galleries` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
--
...
('root', '[{"db":"bilderdb_4h_roth","table":"galleries"},{"db":"bilderdb_4h_roth","table":"users"},{"db":"bilderdb_4h_roth","table":"pictures"}]');
...
('root', 'bilderdb_4h_roth', 'users', '{"sorted_col":"`users`.`email`  DESC"}', '2017-03-30 08:55:54');
...
('root', '2017-03-10 13:04:06', '{"lang":"de","collation_connection":"utf8mb4_unicode_ci"}');
